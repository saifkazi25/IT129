...
export async function POST(req: NextRequest) {
  try {
    ...
    const fantasyPrompt = `high-resolution concept art of a ${quizAnswers[2]} wearing ${quizAnswers[3]}, in a ${quizAnswers[4]} setting, theme: ${quizAnswers[5]}, powers: ${quizAnswers[6]}. Cinematic style, colorful fantasy world, sharp focus, full body, front-facing, eyes visible`;
